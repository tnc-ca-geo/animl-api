...
const CONFIG = {
  ...
  ANIML_API_URL: 'https://xnjdawbz5j.execute-api.us-west-1.amazonaws.com/dev/',
  INFERENCE_QUEUE_URL: 'https://sqs.us-west-1.amazonaws.com/830244800171/inferenceQueue',
